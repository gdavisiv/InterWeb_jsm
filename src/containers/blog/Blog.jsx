    ...
    <div className="gpt3__blog section__padding" id="blog">
      ...
      <div className="gpt3__blog-container">
        <div className="gpt3__blog-container_groupA">
          <Article imgUrl={blog01} date="May 23, 2022" text = "Overview: OpenAI API is powered by a family of models with different capabilities and price points." />
        </div>
        <div className="gpt3__blog-container_groupB">
          ...
          <Article imgUrl={blog05} date="Jan 11, 2022" text = "What is Curie: Curie is extremely powerful, yet very fast. While providing.." />
        </div>
      </div>
    </div>
  )
